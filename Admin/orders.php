      ...
      <div class="col">
        <div style="height: 80vh; overflow: auto;">
          ...
          <table class="table">
            ...
            <tbody>
              <?php
              $orders = mysqli_query($connection, "select * from orders order by date desc, order_id desc");
              ...
              while ($order = mysqli_fetch_array($orders)) {
                ...
                if ($order['status'] == 'pending') {
                  echo "<td><a class='btn btn-success btn-sm' href='orders.php?action=update&order_id={$order['order_id']}'>Complete</a></td>";
                } else {
